...
const defaultDogs: WalkAvailableDog[] = [{ id: 1, name: 'dog', profilePhotoUrl: null, isChecked: false }];
const useWalkAvailable = () => {
    const [walkAvailableDogs, setWalkAvailableDogs] = useState<WalkAvailableDog[] | undefined>(defaultDogs);
